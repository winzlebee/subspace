<script lang="ts">
  ...
  import { getMe, listServers, listChannels, getServerMembers, getMessages } from "$lib/api";
  import {
    currentUser, servers, currentServerId, currentServer,
    channels, currentChannelId, currentChannel, messages, members,
    showSettings, showCreateServer, voiceChannelId
  } from "$lib/stores";
